...
import com.ev.android.evodshd.newyys.R;
...
public class HomeActivity extends Activity implements OnClickListener {
	...
	private ListView mGridSeconMenu;
	...
	public LinearLayout mLine_his, home_search;
...
//					Log.d("timer",MyApplication.white);
	...
	private void initView() {
		...
		mGridSeconMenu = (ListView) findViewById(R.id.secon_menu_grid);
		mGridSeconMenu.setOnItemClickListener(new OnSeconMenuItemClickListener());
		mGridSeconMenu.setOnItemSelectedListener(new OnSecMenuItemSelectedListener());
		...
		// set focus
		mLeftMenuListView.setNextFocusRightId(R.id.secon_menu_grid);
		mLine_his.setNextFocusRightId(R.id.secon_menu_grid);
		home_search.setNextFocusRightId(R.id.secon_menu_grid);
		
		mGridSeconMenu.setNextFocusUpId(R.id.secon_menu_grid);
		mGridSeconMenu.setNextFocusDownId(R.id.secon_menu_grid);
		mGridSeconMenu.setNextFocusLeftId(R.id.main_cat_list);
		mGridSeconMenu.setNextFocusRightId(R.id.main_subcat_grid);
		
		mGridVodShow.setNextFocusUpId(R.id.main_subcat_grid);
		mGridVodShow.setNextFocusDownId(R.id.main_subcat_grid);
		mGridVodShow.setNextFocusLeftId(R.id.secon_menu_grid);
		mGridVodShow.setNextFocusRightId(R.id.main_subcat_grid);
	}

	private class OnSecMenuItemSelectedListener implements OnItemSelectedListener {
