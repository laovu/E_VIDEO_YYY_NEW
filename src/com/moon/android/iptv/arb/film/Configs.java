...
public class Configs {
	...
	public static final String APPID = "28300";//22203
	public static final String PKG_NAME = "com.ev.android.evodshd.newyys";
	public static boolean isLastNeedPassword = true;  //最后一项输入密码
	public static boolean canSearchLastMenu = false;  //是否可以搜索出限制级内容
	public static boolean showHistoryLastMenu = false;  //历史记录是否显示限制级内容
	public static String mLastCid;//最后一级栏目ID
